...
$(function ($) {
  $.fn.blowup = function (attributes) {
    ...
    $element.mousemove(function (e) {
      ...
      const zoomX = -Math.floor(relX / $element.width() * (NATIVE_IMG.width * $options.scale) - $options.width / 2);
      const zoomY = -Math.floor(relY / $element.height() * (NATIVE_IMG.height * $options.scale) - $options.height / 2);
